...
exports.DoneReg = () =>{
	return`ou anregistre deja`
	}
exports.UmurReg = () =>{
	return`li pa bon`
	}
exports.NamaReg = () =>{
	return`nonw tro long utilize bon nonw`
	}
exports.HobiReg = () =>{
	return`You have a lot of hobbies, just 1 or 2 hobbies`
	}
exports.RegReg = (a,b,c,d,e,f,g,h,i) =>{
	return`╭─「 *ou verifye ak siksès* 」
